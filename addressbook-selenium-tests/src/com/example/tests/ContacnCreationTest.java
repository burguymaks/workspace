...
public class ContacnCreationTest {
  ...
  public void testUntitled() throws Exception {
    ...
    driver.findElement(By.name("home")).sendKeys("home 1");
    driver.findElement(By.name("mobile")).clear();
    driver.findElement(By.name("mobile")).sendKeys("mobile 1");
    driver.findElement(By.name("work")).clear();
    driver.findElement(By.name("work")).sendKeys("work 1");
    driver.findElement(By.name("email")).clear();
    driver.findElement(By.name("email")).sendKeys("email 1");
